...
import 'package:expense_tracker/ui/views/dashboard/dashboard_view.dart' as _i4;
...
import 'package:expense_tracker/ui/views/expense_list/expense_list_view.dart'
    as _i7;
import 'package:expense_tracker/ui/views/home/home_view.dart' as _i2;
import 'package:expense_tracker/ui/views/startup/startup_view.dart' as _i3;
...
class Routes {
  ...
  static const expenseFormView = '/expense-form-view';

  static const expenseListView = '/expense-list-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      ...
      page: _i5.ExpenseDetailView,
    ),
    _i1.RouteDef(
      Routes.expenseFormView,
      page: _i6.ExpenseFormView,
    ),
    _i1.RouteDef(
      Routes.expenseListView,
      page: _i7.ExpenseListView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i6.ExpenseFormView: (data) {
      final args = data.getArgs<ExpenseFormViewArguments>(
    ...
    _i7.ExpenseListView: (data) {
      final args = data.getArgs<ExpenseListViewArguments>(
        orElse: () => const ExpenseListViewArguments(),
      );
      return _i8.MaterialPageRoute<dynamic>(
        builder: (context) => _i7.ExpenseListView(key: args.key),
        settings: data,
      );
    },
  };
...
class ExpenseListViewArguments {
  const ExpenseListViewArguments({this.key});
  ...
  @override
  bool operator ==(covariant ExpenseListViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key;
  }
...
extension NavigatorStateExtension on _i9.NavigationService {
  ...
  Future<dynamic> navigateToExpenseListView({
    _i8.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    ...
    return navigateTo<dynamic>(Routes.expenseListView,
        arguments: ExpenseListViewArguments(key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithExpenseListView({
    _i8.Key? key,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    ...
    return replaceWith<dynamic>(Routes.expenseListView,
        arguments: ExpenseListViewArguments(key: key),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
